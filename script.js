function manejarClick(casilla, parrafo, opcion1, opcion2, audio1, audio2) {
  ...
  manejarClick(casilla3, numero3, optionBateria, optionBateria2, audioBateria, audioBateria2); 
  ...
  manejarClick(casilla4, numero4, optionGaita, optionGaita2, audioGaita, audioGaita2);
...
const casilla5 = document.querySelector(".casilla5");
  ...
  manejarClick(casilla5, numero5, optionPandereta, optionPandereta2, audioPandereta, audioPandereta2);
  ...
  manejarClick(casilla6, numero6, optionPiano, optionPiano2, audioPiano, audioPiano2);
  ...
  manejarClick(casilla7, numero7, optionTimbales, optionTimbales2, audioTimbales, audioTimbales2);
  ...
  manejarClick(casilla8, numero8, optionTriangulo, optionTriangulo2, audioTriangulo, audioTriangulo2); 
